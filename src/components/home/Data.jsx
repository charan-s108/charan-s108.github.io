...
const Data = () => {
  const [typeEffect] = useTypewriter({
    words: ['Cloud Security Enthusiast', 'System Administrator', 'Red Team Engineer'],
    smartBackspace: true,
    startDelay: 500,
    typeSpeed: 50,
    backDelay: 500,
  ...
  return (
    <div className="home__data">
      <h1 className="home__title" data-aos="fade-right" data-aos-duration="1500">
        Hi, I'm Charan
        <svg
          width="36"
          height="36"
      ...
      <h3 className="home__subtitle" data-aos="fade-left" data-aos-duration="1500">
        <span className="typeEffect">{typeEffect}</span>
      </h3>
      <p className="home__description" data-aos="fade-left" data-aos-duration="1500">
        Transforming my journey, protecting the cloud's domain as a dedicated
        guardian.
      </p>

      <a href="#contact" className="button button--flex" data-aos="zoom-in" data-aos-duration="1500">
        Say Hello
        <svg
          class="button__icon"
          xmlns="http://www.w3.org/2000/svg"
